...
#sys.path.append(os.path.join(BASE_DIR, 'data_prep'))
sys.path.append(os.path.join(BASE_DIR, 'part_seg'))
import part_dataset
...
DATA_PATH = os.path.join(BASE_DIR, 'data', 'shapenetcore_partanno_segmentation_benchmark_v0_normal')
